...
folder_path = pathlib.Path('./datasets/tid2013/distorted_images')
ref_path = pathlib.Path('./datasets/tid2013/reference_images')
base_path = pathlib.Path('./metrics_values/TID2013_pyiqa_metrics')
...
for metric in metrics:
    ...
    csv_path = base_path / f'TID2013_{metric}.csv'
    ...
    for idx, image in enumerate(tqdm(image_files, desc="Processing images")):
        ...
        ref_image = str(dist_image.name).split("_")[0]
        ref_image = ref_path / f'{ref_image}.bmp'
