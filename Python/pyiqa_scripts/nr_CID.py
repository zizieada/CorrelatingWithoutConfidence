...
metrics = ['clipiqa+', 'musiq', 'maniqa', 'topiq_nr', 'tres', 'hyperiqa', 'dbcnn', 'paq2piq', 'wadiqam_nr']

# Step 1: Set up the directory path where your images are located
base_path = pathlib.Path('./datasets/CID2013/')
folder_path = base_path / 'CID2013'  # Replace with your folder path
...
for metric in metrics:
    ...
    csv_path = base_path / f'CID2013_{metric}.csv'
